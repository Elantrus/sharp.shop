...
<div class="flex flex-col gap-10 items-center min-h-full md:w-96 self-center">
    ...
    <form on:submit|preventDefault={register} class="flex flex-col gap-2 w-full">
        ...
        <Input bind:value={createCustomerModel.password} type="text" bind:isValid={formValidation["name"].valid}>Name</Input>

        <Input bind:value={createCustomerModel.password} type="text" bind:isValid={formValidation["surName"].valid}>Surname</Input>
